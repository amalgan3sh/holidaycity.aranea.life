...
<body>
    ...
    <section class="common-banner-section">
        ...
        <section class="about-us-page padding-bottom padding-top" id="inspiration">
            <div class="container">
                <div class="section-title">
                    <h2><center> PROJECT <b> IMPLEMENTATION</b> STRATEGY </center></h2><br>
                </div>
            </div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p> 
                                Land acquisition, site preparation, and road development.
                            </p>
                            <p>
                                Initial construction of farmhouses and resort villas. 
                            </p>
                            <h3>Phase 2:</h3><br>
                            <p>
                                Construction of healthcare facilities, exotic park, and hydropower plant.
                            </p>
                            <p>
                                Collaboration with partners for healthcare and renewable energy projects. 
                            </p>
                            <h3>Phase 3:</h3><br>
                            <p>
                                Completion of the natural mineral water management system and final landscaping.
                            </p>
                            <p>
                                Sale of farmhouses and resort villas, as well as marketing of healthcare facilities.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
