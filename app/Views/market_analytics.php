...
<body>
    ...
    <section class="common-banner-section">
        ...
        <section class="about-us-page padding-bottom padding-top" id="inspiration">
            <div class="container">
                <div class="section-title">
                    <h2><center> MARKET <b> ANALYTICS</center></b></h2><br>
                </div>
            </div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p> 
                                <b>Real Estate Buyers :</b> High-net-worth individuals looking for luxury
                                farmhouses and resort villas.
                            </p><br>
                            <p>
                                <b>Healthcare Providers :</b> Investors seeking to develop or collaborate on
                                innovative healthcare facilities.
                            </p><br>
                            <p>
                                <b>Sustainability-Focused Buyers :</b> Buyers interested in eco-friendly,
                                carbon-efficient properties.
                            </p><br>
                            <p>
                                <b>Renewable Energy Investors :</b> Companies or individuals looking to
                                invest in hydropower and renewable energy projects. 
                            </p>
                            <h3>Market Trends :</h3><br>
                            <p>
                                <b>Luxury Real Estate :</b> There is a growing demand for high-end, eco-friendly living spaces in India. 
                            </p>
                            <p>
                                <b>Healthcare Real Estate :</b> Investment in healthcare infrastructure is
                                increasing, especially in ecotourism and wellness. 
                            </p>
                            <p>
                                <b>Sustainability :</b> Sustainable urban developments are gaining
                                popularity due to environmental concerns and government regulations.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
