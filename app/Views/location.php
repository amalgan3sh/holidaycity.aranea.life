...
<body>
    ...
    <section class="common-banner-section">
        ...
        <section class="about-us-page padding-bottom padding-top" id="inspiration">
            <div class="container">
                <div class="section-title">
                    <h2><center> Kerala <b> - God's Own Country</center></b></h2><br>
                </div>
            </div>
            <div class="container">
                ...
                <div class="row align-items-center">
                    <p style="text-align: justify;"><br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Kerala, often referred to as "God's Own Country," is a land of unparalleled beauty, where nature's bounty and cultural richness intertwine 
                        harmoniously. Nestled between the Arabian Sea and the lush Western Ghats, Kerala is a tapestry of vibrant landscapes, from the emerald 
                        backwaters and palm-fringed beaches to the misty hill stations and sprawling tea plantations. Its cultural heritage is as diverse as its 
                        geography, with traditions like Kathakali, Mohiniyattam, and the awe-inspiring temple festivals that showcase the state's deep-rooted 
                        devotion and artistic excellence. Kerala's cuisine is a delightful celebration of flavors, with coconut, spices, and fresh seafood at its 
                        heart, offering everything from the fiery heat of fish curry to the subtle sweetness of payasam. The state's commitment to preserving its 
                        natural beauty is evident in the pristine sanctuaries and wildlife reserves that are home to elephants, tigers, and a myriad of exotic 
                        species. Kerala's lifestyle, characterized by a slower, more relaxed pace, promotes a balance between work and leisure, with a strong 
                        emphasis on family, health, and community. Its world-class healthcare system, high literacy rate, and progressive outlook make it a haven 
                        for those seeking a fulfilling and peaceful life. Whether you're exploring its picturesque villages, savoring its unique cuisine, or simply 
                        soaking in the serenity of its landscapes, Kerala is a destination that leaves an indelible mark on your heart and soul. 
                    </p>
                </div>
            </div>
        </section>
