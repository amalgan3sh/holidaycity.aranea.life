                    ...
                    <form action="#">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-3 col-12">
                                <div class="form-group">
                                    <select>
                                        <option value="Type: House">Type: House</option>
                                        <option value="Type: House">Type: House</option>
                                        <option value="Type: House">Type: House</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-4 col-12">
                                <div class="form-group">
                                    <select>
                                        <option value="Min Price: 500,000 USD">Min Price: 500,000 USD</option>
                                        <option value="Min Price: 500,000 USD">Min Price: 500,000 USD</option>
                                        <option value="Min Price: 500,000 USD">Min Price: 500,000 USD</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-4 col-12">
                                <div class="form-group">
                                    <select>
                                        <option value="Max Price: 500,000 USD">Max Price: 500,000 USD</option>
                                        <option value="Max Price: 500,000 USD">Max Price: 500,000 USD</option>
                                        <option value="Max Price: 500,000 USD">Max Price: 500,000 USD</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-4 col-12">
                                <div class="form-group">
                                    <select>
                                        <option value="Area: 600 m2">Area: 600 m2</option>
                                        <option value="Area: 600 m2">Area: 600 m2</option>
                                        <option value="Area: 600 m2">Area: 600 m2</option>
                                    </select>
                                </div>
                ...
                <div class="row row-gap">
                                ...
                                <div class="swiper-slide product-card">
                                    <div class="product-card-inner">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h5>
                                                <a href="product.html">
                                                    A modern home in the comfort of San Francisco
                                                </a>
                                            </h5>
                                            <ul class="product-tag">
                    ...
                    <div class="col-lg-5 col-xl-6 col-12">
                        <div class="place-map-img">
                            <img src="assets/images/place-map.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide category-itm">
                            <div class="category-itm-inner">
                                ...
                                <div class="category-content">
                                    <h4><a href="#">Investment plots</a></h4>
                                    <a href="#" class="btn-icon"><svg xmlns="http://www.w3.org/2000/svg" width="17"
                                            height="17" viewBox="0 0 17 17" fill="none">
                                            <g clip-path="url(#clip0_27_3418)">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="swiper-slide blog-itm">
                            <div class="blog-itm-inner">
                                ...
                                <div class="blog-itm-content">
                                    ...
                                    <h5>
                                        <a href="article.html">A modern home in the comfort of San Francisco </a>
                                    </h5>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
