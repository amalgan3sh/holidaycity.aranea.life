...
<body>
    ...
    <section class="common-banner-section">
        ...
        <section class="about-us-page padding-bottom padding-top" id="inspiration">
            <div class="container">
                <div class="section-title">
                    <h2><center> Project <b> Components</center></b></h2><br>
                </div>
            </div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p> 
                                <b>Land Allocation :</b> 100 acres (1 acre per farmhouse).
                            </p><br>
                            <p>
                                <b>Building Cost :</b> ₹35 lakh per farmhouse. 
                            </p><br>
                            <p>
                                <b>Selling Price :</b> ₹1 crore per farmhouse.
                            </p><br>
                            <p>
                                <b>Total Revenue :</b> ₹100 crore. 
                            </p>
                            <p> 
                                These farmhouses will offer luxury living
                                amidst a natural environment, blending sustainability with comfort.
                                Each farmhouse will be designed to meet the highest energy
                                efficiency standards and will include modern amenities, while
                                maintaining harmony with the surrounding landscape. 
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                ...
                <div class="row align-items-center row-reverse">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p> 
                                <b>Land Allocation :</b> 10 acres (10 cents per villa). 
                            </p><br>
                            <p>
                                <b>Building Cost :</b> ₹15 lakh per villa. 
                            </p><br>
                            <p>
                                <b>Selling Price :</b> ₹30 lakh per villa. 
                            </p><br>
                            <p>
                                <b>Total Revenue :</b> ₹30 crore. 
                            </p>
                            <p>
                                The resort villas are designed to cater to tourists seeking a luxurious
                                and eco-friendly retreat. Each villa will be constructed using
                                sustainable materials and will be energy efficient, ensuring minimal
                                environmental impact while providing a comfortable living
                                experience.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p> 
                                <b>Land Allocation :</b> 10 acres. 
                            </p><br>
                            <p>
                                <b>Construction Cost :</b> ₹10 crore.
                            </p><br>
                            <p>
                                <b>Collaboration Value :</b> ₹30 crore. 
                            </p><br>
                            <p>
                                The healthcare facilities will serve
                                both residents and the broader community, providing cutting-edge
                                medical services in a sustainable setting. This component of the
                                project emphasizes wellness and preventive healthcare, with the
                                potential for collaboration with healthcare institutions and investors.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                ...
                <div class="row align-items-center row-reverse">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p>
                                <b>Construction Cost :</b> ₹20 crore. 
                            </p><br>
                            <p>
                                <b>Collaboration Value :</b> ₹40 crore. 
                            </p><br>
                            <p>
                                The exotic park will feature a wide
                                variety of flora and fauna, offering visitors a chance to connect with
                                nature. The park will be integrated with an advanced waste
                                management system, promoting environmental conservation and
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p>
                                <b>Construction Cost :</b> ₹35 crore. 
                            </p><br>
                            <p>
                                <b>Collaboration Value :</b> ₹100 crore.
                            </p><br>
                            <p>
                                <b>Capacity :</b> 5 MW renewable energy generation.
                            </p><br>
                            <p>
                                This renewable energy facility will power the development, ensuring energy
                                independence for the community. The hydropower plant will
                                contribute to the overall sustainability of the project while generating
                                revenue from surplus energy production. 
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                ...
                <div class="row align-items-center row-reverse">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p>
                                <b>Revenue Generation: :</b> 
                                2 lakh liters of mineral water sold daily at
                                ₹5/liter, generating ₹10 lakh per day. The mineral water management
                                system will store and distribute fresh, natural mineral water. This
                                system will contribute to local and global efforts to provide clean
                                drinking water, and will also generate significant revenue. 
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
