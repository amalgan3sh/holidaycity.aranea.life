...
<body>
    ...
    <section class="common-banner-section">
        ...
        <section class="about-us-page padding-bottom padding-top" id="inspiration">
            <div class="container">
                <div class="section-title">
                    <h2><center> TECHNICAL FEASIBILITY <b> and</b>
                    INFRASTRUCTURE PLANNING </center></h2><br>
                </div>
            </div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="abt-shp-column-left">
                            ...
                            <p> 
                                <b>Road Networks :</b> Well-developed road networks to ensure
                                smooth transit across the project. The roads will be designed with
                                drainage systems to prevent waterlogging during monsoon
                                seasons. 
                            </p>
                            <p>
                            ...
                            <p>
                                <b>Energy :</b> The hydropower plant will supply renewable energy to
                                all project components. Surplus energy will be sold to the grid,
                                generating additional revenue.
                            </p>
                            <p>
                                <b>Water Management :</b> A comprehensive water management
                                system will store and distribute mineral water, reducing
                                dependency on external water sources.
                            </p>
                            <p>
                                <b>Waste Management :</b> The waste management system will
                                handle both organic and inorganic waste generated by the
                                residents and tourists, maintaining the project's environmental
                                sustainability.
                            </p>
                        </div>
                    </div>
