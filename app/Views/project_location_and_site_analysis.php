...
<body>
    ...
    <section class="common-banner-section">
        ...
        <section class="about-us-page padding-bottom padding-top">
            <div class="container">
            <div class="section-title">
                    <h2><center>Project Location <b> and </b> Site Analysis</center></h2><br>
                </div>
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="about-us-content">
                            ...
                            <b>Location : </b>
                            The project is situated in Kolichal, Kasargod, Kerala, India. <br><br>

                            <b>Total Area: 228 acres. </b>
                            <b>Accessibility :</b> The site is located near major transportation
                            routes, ensuring ease of access for both residents and tourists.
                            The nearby road networks will facilitate the movement of
                            goods, people, and services within the project. <br><br>

                            <b>Topography and Climate :</b> Kasargod’s tropical climate makes
                            it ideal for growing teak and other vegetation. The topography
                            features lush green hills, and the proximity to water bodies
                            makes the location conducive for hydroelectric projects and
                            water management systems.  <br><br>

                            <b>Ecological Importance :</b> The site is rich in biodiversity and
                            presents an opportunity to preserve the natural environment
